...
-- Dumping data for table fevrok.data_states: ~4,120 rows (approximately)
DELETE FROM `data_states`;
/*!40000 ALTER TABLE `data_states` DISABLE KEYS */;
INSERT INTO `data_states` (`id`, `name`, `country_id`) VALUES
	...
	(4120, 'Midlands', 246);
/*!40000 ALTER TABLE `data_states` ENABLE KEYS */;
